...
reviews_data = [
  { review_id: 1, user_netid: 'shreyasskasetty', applicant_id: '8914560391',
    review_info: 'Excellent research proposal.', created_at: Time.now, updated_at: Time.now, rating: 5, status: 'Completed', gar: true, gat: false },
  { review_id: 2, user_netid: 'shreyasskasetty', applicant_id: '6614544379',
    review_info: 'Good academic record, but lacking in publications.', created_at: Time.now, updated_at: Time.now, rating: 3, status: 'InProgress', gar: false, gat: true },
  { review_id: 3, user_netid: 'shreyasskasetty', applicant_id: '9570272315',
    review_info: 'Strong letters of recommendation.', created_at: Time.now, updated_at: Time.now, rating: 4, status: 'Assigned', gar: true, gat: true }
