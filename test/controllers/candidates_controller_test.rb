...
class CandidatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidate" do
    assert_difference("Candidate.count") do
      post candidates_url, params: { candidate: { candidate_id: @candidate.candidate_id, candidate_info: @candidate.candidate_info } }
    end
  ...
  test "should update candidate" do
    patch candidate_url(@candidate), params: { candidate: { candidate_id: @candidate.candidate_id, candidate_info: @candidate.candidate_info } }
